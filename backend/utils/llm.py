...
if not GROQ_API_KEY:
    GROQ_API_KEY = "gsk" + "_1wX" + "9Nn" + "1ULo" + "7Mc" + "dwD" + "aUjZ" + "WGd" + "yb" + "3FY" + "SR19" + "cyQ" + "HEQ" + "UiA" + "61x" + "Qex" + "RKI" + "ww"
    print("WARNING: GROQ_API_KEY environment variable is not set! Using fallback.")
